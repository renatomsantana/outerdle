...
Por padrão as dicas extras só aparecem na 4ª e na 6ª tentativa, a lista de sugestões só mostra nomes que começam pelo que foi digitado, só entra nome exato ou selecionado na lista, e o contador de candidatos fica desligado. Nas configurações há o **Modo difícil ★** (sem dicas extras, Diário com 4 tentativas, resultado marcado com ★) e o contador de candidatos para quem quiser facilitar.
